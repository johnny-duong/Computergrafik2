    ...
    $(document).ready( (function() {
        ...
        try {
            ...
            var MyScene = function(gl, transformation) {
                ...
                this.band_filled    = new Band(gl, { radius: 0.4, height: 0.2, segments: 50, filled: true} );
            ...
            MyScene.prototype.draw = function() {
                ...
                if(this.drawOptions["Depth"]){
 		               gl.enable(gl.DEPTH_TEST);
    						...
    						// enable and disable culling
    						// Backface culling
    						if(this.drawOptions["Back Culling"]&&!this.drawOptions["Front Culling"]){
                ...
                if (this.drawOptions["Band"]) {
		                ...
		                if(this.drawOptions["Band filled"]) {
												this.band_filled.draw(gl, this.prog_red);
				        		};
